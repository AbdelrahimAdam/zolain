...
const Layout = ({ children, role = 'student' }) => {
  ...
  const getBackgroundGradient = () => {
    switch (role) {
      case 'admin': return 'bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-blue-900/30';
      case 'teacher': return 'bg-gradient-to-br from-cyan-50 to-blue-100 dark:from-gray-900 dark:to-cyan-900/30';
      case 'student': return 'bg-gradient-to-br from-green-50 to-emerald-100 dark:from-gray-900 dark:to-green-900/30';
      default: return 'bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800';
    }
  };
